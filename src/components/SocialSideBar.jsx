  ...
  return (
    <>
      <div className="fixed right-5 bottom-5 lg:bottom-10 flex flex-col gap-2">
        <button
          ref={githubIcon}
          className="hidden sm:block rounded-3xl font-['Agdasima'] rounded-3xl text-white animate- bg-blue-500/70 hover:bg-orange-400 hover:text-black animate__animated animate__bounceInUp"
        >
        ...
        <button
          ...
          className="sm:hidden rounded-3xl font-['Agdasima'] rounded-3xl text-white animate- bg-blue-500/70 hover:bg-orange-400 active:bg-orange-500 hover:text-black"
        >
